...
def obtener_apiqroo():
    ...
    for fila in soup.find_all("tr"):
        ...
        # -------------------------------------------------
        # Evitar duplicados
        # del mismo barco en la misma terminal
        # -------------------------------------------------
        existe = any(
    ...
    # -----------------------------------------------------
    # IMPORTANTE:
    # return está dentro de la función
    # -----------------------------------------------------
    return cruceros
...
def main():
    ...
    print(
        "Obteniendo pasajeros..."
    )
    pasajeros = obtener_pasajeros()
    relacionados = 0
    # -----------------------------------------------------
    # Relacionar pasajeros con cruceros
    # -----------------------------------------------------
    for dia in cruceros:
